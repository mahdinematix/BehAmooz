...
namespace ServiceHost.Areas.Administration.Pages.Account
{
    public class EditModel : UserContextPageModel
    {
        ...
        public EditModel(IAccountApplication accountApplication, IRoleApplication roleApplication, IAuthHelper authHelper, IUniversityApplication universityApplication) : base(authHelper)
        {
