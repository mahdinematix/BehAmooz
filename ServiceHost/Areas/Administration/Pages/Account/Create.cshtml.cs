...
namespace ServiceHost.Areas.Administration.Pages.Account
{
    public class CreateModel : UserContextPageModel
    {
        ...
        public CreateModel(IAccountApplication accountApplication, IRoleApplication roleApplication, IAuthHelper authHelper, IUniversityApplication universityApplication) : base(authHelper)
        {
        ...
        public IActionResult OnGet()
        {
            ...
            Roles = new SelectList(_roleApplication.GetAllRoles(CurrentAccountRole), "Id", "Name");
