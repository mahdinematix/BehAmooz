...
public class OrderItem : EntityBase
{
    ...
    public long SessionPrice { get; private set; }
    ...
    public OrderItem(long sessionId, long sessionPrice, int sessionNumber,long professorId, string professorFullName, string classStartTime, string classEndTime, int classDay, long classId, string courseName)
    {
        SessionId = sessionId;
