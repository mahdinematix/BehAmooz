...
namespace _01_Framework.Application
{
    public static class Tools
    {
        ...
        public static TimeOnly ToGeorgianTime(this string persianTime)
        {
            persianTime = persianTime.ToEnglishNumber();
            var hour = Convert.ToInt32(persianTime.Substring(0, 2));
            var minute = Convert.ToInt32(persianTime.Substring(3, 2));
            return new TimeOnly(hour, minute);

        }

        public static string ToShownTime(this string persianTime)
        {
